...
namespace Lab2LinqSchool.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var schoolContext = _context.Students.Include(s => s.Classes);
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentFirstName,StudentLastName,ClassId")] Student student)
        {
